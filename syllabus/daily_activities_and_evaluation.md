...
Each training day, allocate additional time to run these structured parallel learning activities:
...
The final grade for the research internship is calculated using the following weighted categories:
...
#### 1. Ubuntu & Linux Proficiency (10% Weight)
...
#### 3. Package Development (15% Weight)
...
#### 4. Topics, Services & Actions (15% Weight)
...
#### 6. Dobot Magician Integration (15% Weight)
...
#### 7. 6-DoF Controller Stack Design (10% Weight)
...
#### 8. Documentation, Git & Presentation (5% Weight)
