...
title: week3_integration
date: '2026-07-31 20:18:00.000'
from_notion: https://app.notion.com/p/week3_integration-3aec4db880d9817fb129d03db405e94c
...
1. **Robot Links: Physical Parameters**
...
1. **Robot Joints: Kinematic Links**
...
1. **MoveIt2 (Motion Planning Framework)**
...
1. **Modular Surgical Robot Software Stack**
...
- **Task**: Design a modular software module architecture for the Taurean 6-DoF Surgical Robot. Document this architecture in a markdown file (`surgical_robot_design.md`). Include a system component diagram (using Mermaid syntax) representing the interaction between:
	...
	1. Joint trajectory controllers.

	1. Real-time controller manager.

	1. Low-level CAN/EtherCAT driver interface.
...
1. **Final Presentation / Live Demonstration**
