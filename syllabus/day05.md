...
### 📌 TL;DR
Understand nodes (the modular building blocks), topics (the data pipelines), messages (the data formats), and write your first Python-based publisher and subscriber.
...
* **Task**: Create two nodes from scratch:
  ...
  2. `alarm_subscriber.py`: Subscribes to `/battery_status` and triggers a terminal warning alert if the charge falls below 20.0.
