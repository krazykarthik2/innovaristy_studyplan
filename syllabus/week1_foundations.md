...
2. **Dual Boot vs. Virtual Machine (VM)**
...
4. **Terminal Commands (CLI Essentials)**
...
8. **Package Manager (APT - Advanced Package Tool)**
...
2. **System Services (systemd & systemctl)**
...
6. **Linux Networking for Multi-Agent Robotics**
...
8. **SSH & Remote Device Interfacing**
...
3. **Object-Oriented Programming (OOP) in Robotics**
   * Classes and Objects.
...
5. **Multithreading, Multiprocessing, and Concurrency**
...
3. **ROS2 Core Architecture Layers**
...
*Proceed to [**Week 2: ROS2 Development**](week2_development.md) for package management, services, parameters, actions, launch files, and transform frames.*
